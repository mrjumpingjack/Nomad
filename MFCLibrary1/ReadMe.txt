========================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: MFCLibrary1-Projektübersicht
========================================================================


Diese MFCLibrary1-DLL wurde vom Anwendungs-Assistenten für Sie erstellt. Diese DLL zeigt nicht nur die Grundlagen der Verwendung von
Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das
Schreiben Ihrer DLL.

Diese Datei enthält eine Zusammenfassung dessen, was sich in den Dateien befindet, aus denen Ihre MFCLibrary1–DLL besteht.
...
MFCLibrary1.h
    Dies ist die Hauptheaderdatei für die DLL. Sie deklariert die CMFCLibrary1App-Klasse.

MFCLibrary1.cpp
    Dies ist die Hauptquelldatei der DLL. Sie enthält die CMFCLibrary1App-Klasse.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MFCLibrary1.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
